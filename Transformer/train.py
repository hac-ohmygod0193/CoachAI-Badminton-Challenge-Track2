...
def draw_loss(k_fold_index, record_total_loss, record_val_loss, config):
    ...
    plt.legend()
    plt.savefig(config['output_folder_name'] + '/' + 'loss.png') #edit
...
def get_argument():
    ...
    opt.add_argument("--output_folder_name",
                        type=str,
                        default='output', #edit no default
...
config['filename'] = './data/train.csv' #edit
...
print("encode_length",config['encode_length'])
